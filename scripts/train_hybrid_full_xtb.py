...
def _collect_model_overrides() -> dict[str, int | float | str]:
    mapping = {
        ...
        "HYBRID_COLAB_USE_MECHANISTIC_SOM_HEAD": (_env_int, "use_mechanistic_som_head"),
        "HYBRID_COLAB_MECHANISTIC_HIDDEN_DIM": (_env_int, "mechanistic_hidden_dim"),
        "HYBRID_COLAB_MECHANISTIC_DROPOUT": (_env_float, "mechanistic_dropout"),
        "HYBRID_COLAB_MECHANISTIC_INIT_SCALE": (_env_float, "mechanistic_init_scale"),
        "HYBRID_COLAB_MECHANISTIC_USE_LEARNED_WEIGHTS": (_env_int, "mechanistic_use_learned_weights"),
        "HYBRID_COLAB_MECHANISTIC_BLEND_MODE": (_env_str, "mechanistic_blend_mode"),
