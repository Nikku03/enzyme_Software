...
def create_micropattern_dataloaders_from_drugs(
    ...
    *,
    ...
    train_loader = DataLoader(train_exp, batch_size=batch_size, shuffle=True, collate_fn=base_collate_fn)
    val_loader = DataLoader(val_exp, batch_size=batch_size, shuffle=False, collate_fn=base_collate_fn)
    test_loader = DataLoader(test_exp, batch_size=batch_size, shuffle=False, collate_fn=base_collate_fn)
